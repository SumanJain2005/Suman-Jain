            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                ...
                <div className="w-full lg:w-1/2">
                    ...
                    >
                        ...
                        <motion.a variants={childVariants} href="https://drive.google.com/file/d/14habPGUzkDjYVZdiouKSs5urncPGAa9b/view?usp=sharing" download className="bg-white rounded-full p-4 text-sm text-stone-800 mb-10">Download Resume</motion.a>
                    </motion.div>
                </div>
            </div>
        </div>
